...
@section('content')
    <div class="container">
        ...
        @endif
        <form action=" {{ route('route_BE_Admin_Add_San_Bay') }} " method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ old('ten_sb') }}" type="text" name="ten_sb" class="form-control" id="chuyenBay"
                    ...
                    <div class="mb-3">
                        ...
                        <input value="{{ old('dia_chi_sb') }}" type="text" name="dia_chi_sb" class="form-control"
                        ...
                        <div class="mb-3">
                            ...
                            <textarea value="{{ old('mo_ta_sb') }}" class="form-control" name="mo_ta_sb" id=""></textarea>
                ...
                <div class="col-6">
                    ...
                    <div class="mb-3">
                        ...
                        <select class="form-control" name="loai_sb" id="">
                            ...
                            <option value="0">Sân bay đi</option>
                            <option value="1">Sân bay đến</option>
                        </select>
                        @error('loai_sb')
                            <span style="color: red"> {{ $message }} </span>
                        @enderror
