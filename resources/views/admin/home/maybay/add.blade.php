...
@section('content')
    <div class="container">
        ...
        @endif
        <form action=" {{route('route_BE_Admin_Add_May_Bay')}} " method="post" enctype="multipart/form-data">
            ...
            <div class="row">
                ...
                <div class="col-6">
                    <div class="mb-3">
                        ...
                        <input value="{{ old('so_hieu_mb') }}" type="text" name="so_hieu_mb" class="form-control"
                        ...
                        <select name="ma_loai_mb_id" id="" class="form-control">
                            ...
                            @if (!empty($list_loai_mb))
                                @foreach ($list_loai_mb as $item)
                                    <option  value="{{ $item->id ?? old('ma_loai_mb_id') }} ">{{ $item->ten_loai_mb ?? old('ten_loai_mb') }}</option>
                                @endforeach
                            @endif
